...
<div class="container">
    ...
    <div class="sidebar">
            ...
            <div class="tab-nav">
                <button type="button" class="active" data-target="tab-info">👤 Thông tin cá nhân</button>
                <button type="button" data-target="tab-password">🔒 Bảo mật</button>
                <button type="button" data-target="tab-orders">📦 Đơn hàng</button>
